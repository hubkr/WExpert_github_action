...
public class WEXDropDownButton : DropDownButton
{
    ...
    public WEXDropDownButton()
    {
        DefaultStyleKey = typeof(WEXDropDownButton);
    ...
    {
        if (d is WEXDropDownButton button)
        {
            button.UpdateCursor(); // 커서 타입이 변경될 때 처리
        }
    }
    ...
    private void UpdateCursor()
    {
        ...
        {
            WExpertLogger.Instance.Error($"WEXDropDownButton UpdateCursor error : {e}");
        }
    }
}