...
public partial class WEXBaseContentDialog : ContentDialog
{
    ...
    protected override void OnApplyTemplate()
    {
        ...
        // TitleTemplate이 로드될 때 DataContext를 설정
        if (TitleTemplate != null)
        {
            var content = TitleTemplate.LoadContent();
    ...
    private void OnAnyPointerMoved(object sender, PointerRoutedEventArgs e)
    {
        ...
        {
            //WExpertLogger.Instance.Debug($"BaseContentDialog: Pointer Moved Detected (Throttled) at {now}");
            NotifyInteraction();
